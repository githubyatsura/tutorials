## Just draft version of fluent Java API to Apache Jackrabbit 2.14 used WEBDAV protocol with help of TestNG 6.x + maven plugins (failsafe + exec.)

Examples contains:

 * a draft version of fluent Java API for collaboration with [Apache Jackrabbit 2.14](http://jackrabbit.apache.org/jcr/downloads.html#v2.14) via WEBDAV protocol.
